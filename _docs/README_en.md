...
Read in other Languages: [🇹🇷Turkish](https://github.com/umitaltintas/SpoofDPI-Turkiye), [🇬🇧English](https://github.com/umitaltintas/SpoofDPI-Turkiye/blob/main/_docs/README_en.md)
...
You can download directly from the [releases](https://github.com/umitaltintas/SpoofDPI-Turkiye/releases) section or
See the installation guide for SpoofDPI [here](https://github.com/umitaltintas/SpoofDPI-Turkiye/blob/main/_docs/INSTALL.md).
